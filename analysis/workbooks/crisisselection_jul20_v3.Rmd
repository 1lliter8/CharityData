...
```{r expend_graph_high, echo = FALSE, fig.align = 'center'}
ewtrusts_prop %>%
  select(expend2019, asktype) %>% 
...
```{r mail_filter_count1, echo = FALSE}
ewtrusts_prop_filt %>% 
...
```{r mail_filter_count2, echo = FALSE}
ewtrusts_prop_filt %>% 
...
```{r mail_filter_count3, echo = FALSE}
ewtrusts_prop_filt %>% 
